...
const Gallery = () => {
  ...
  const products = [
    { id: 1, name: 'Royal Navy Velvet Sofa', category: 'Living Room', price: '$4,500', img: '/sofa.jpg' },
    { id: 2, name: 'Emerald Crown Armchair', category: 'Living Room', price: '$2,200', img: '/chair.jpg' },
    { id: 3, name: 'Majestic King Bed', category: 'Bedroom', price: '$5,800', img: '/bedroom.jpg' },
    { id: 4, name: 'Gold Accent Coffee Table', category: 'Living Room', price: '$1,200', img: '/hero.jpg' },
  ];
